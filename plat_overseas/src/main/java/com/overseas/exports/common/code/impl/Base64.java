...
public class Base64 {
	...
	public static String encode(String input) {
		try {
			String jString = URLEncoder.encode(input, "utf-8");
			jString = new String(Base64.encode(jString.getBytes("iso-8859-1")));
	...
	public static String decode(String input) {
		try {
			String jString = new String(Base64.decode(input.toCharArray()),
					"iso-8859-1");
			jString = URLEncoder.encode(
					new String(jString.getBytes(), "UTF-8"), "utf-8");
			return jString;
		} catch (Exception e) {
			return e.getMessage();
		}
